...
{
int r,i;
stackll s=new stackll(no_of_vertices);
...
r=s.get();
if(adjacent_vertices_visited(r)==false)
{
...
boolean adjacent_vertices_visited(int r)
{
boolean flag=true;
Iterator itr=edges.iterator();
while(itr.hasNext())
{
edge obj=(edge)itr.next();
if(obj.startvertex==r && check_if_visited(obj.endvertex)==0)
{
flag=false;
break;
}
...
graphfordfs g=new graphfordfs(n);
